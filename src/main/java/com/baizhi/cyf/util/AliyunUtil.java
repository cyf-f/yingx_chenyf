...
public class AliyunUtil {
    ...
    public static SendSmsResponse testSendPhoneMsg(String signName,String templateCode,String phoneNumbers,String code) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4Frdf4ujUdW2jwj6rdEe";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret ="Sd5qaangzGsZvZ1BEUfCSMjmEvO0CU";//你的accessKeySecret，参考本文档步骤2
        ...
        //"15620178661,18511052926,18873853888,13366634326"
    ...
    public static String getSendPhoneCode(String phoneNumbers,String code){
        ...
        String templateCode="SMS_183767036";  //模板id
    ...
    public static void main(String[] args) {
        String phoneNumbers="15620178661,18511052926,18873853888,13366634326,15236674712";  //接收短信手机号
        //随机验证码
